    ...
    <div className="w-full py-[10rem] bg-white px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-[90%] mx-auto shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <button className="bg-[#00df9a] rounded-md w-[150px] font-medium my-6 mx-auto px-8 py-2 text-black">
            Free Trial
          </button>
        </div>
        <div className="w-[90%] mx-auto bg-gray-100 border shadow-xl flex flex-col p-4 md:my-0 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <button className="text-[#00df9a] rounded-md w-[150px] font-medium my-6 mx-auto px-8 py-2 bg-black">
            Free Trial
          </button>
        </div>
        <div className="w-[90%] mx-auto shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium ">
            <p className="border-b mx-8 py-2 mt-8 border-t">
              Unlimited Storage
            </p>
