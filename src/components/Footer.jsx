...
const Footer = () => {
  return (
    <div className="w-full bg-black">
      <div className="max-w-[1240px] mx-auto py-16 grid lg:grid-cols-3 gap-8 text-gray-300 bg-black">
        <div>
          ...
          <p className="py-4 pr-4">
            ...
            saepe quidem rem provident ducimus sint corporis ab incidunt ut
            dolore?
          </p>
